...
export type PostFilter = {
  ...
  custom_css?: InputMaybe<StringFilter>;
...
export type PostPartsFragment = { __typename: 'Post', title: string, excerpt?: string | null, author: string, date: string, template: string, theme: string, custom_css?: string | null, tier: string, cover_image?: string | null, body?: any | null };
...
export type PostQuery = { __typename?: 'Query', post: { __typename: 'Post', id: string, title: string, excerpt?: string | null, author: string, date: string, template: string, theme: string, custom_css?: string | null, tier: string, cover_image?: string | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type PostConnectionQuery = { __typename?: 'Query', postConnection: { __typename?: 'PostConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges?: Array<{ __typename?: 'PostConnectionEdges', cursor: string, node?: { __typename: 'Post', id: string, title: string, excerpt?: string | null, author: string, date: string, template: string, theme: string, custom_css?: string | null, tier: string, cover_image?: string | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };
